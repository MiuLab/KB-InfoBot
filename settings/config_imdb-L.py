...
agent_params['nl-rule-no']['ts'] = 1.0
...
agent_params['simple-rl-soft']['tr'] = 1.0
...
agent_params['simple-rl-hard']['ts'] = 5.0
agent_params['simple-rl-hard']['max_req'] = 2
agent_params['simple-rl-hard']['frac'] = 0.1
...
agent_params['simple-rl-no']['max_req'] = 4
...
agent_params['e2e-rl-soft']['tr'] = 1.0
