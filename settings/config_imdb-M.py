...
agent_params['nl-rule-hard']['max_req'] = 1
agent_params['nl-rule-hard']['frac'] = 0.1
agent_params['nl-rule-hard']['upd'] = 10

agent_params['nl-rule-soft'] = {}
agent_params['nl-rule-soft']['tr'] = 1.0
agent_params['nl-rule-soft']['ts'] = 1.0
...
agent_params['simple-rl-soft']['tr'] = 0.5
agent_params['simple-rl-soft']['ts'] = 1.0
agent_params['simple-rl-soft']['max_req'] = 2
agent_params['simple-rl-soft']['frac'] = 0.5
agent_params['simple-rl-soft']['upd'] = 5
...
agent_params['simple-rl-hard']['upd'] = 5
...
agent_params['e2e-rl-soft']['tr'] = 0.5
agent_params['e2e-rl-soft']['ts'] = 1.0
agent_params['e2e-rl-soft']['max_req'] = 2
agent_params['e2e-rl-soft']['frac'] = 0.5
agent_params['e2e-rl-soft']['upd'] = 5
