...
class decoder:
    ...
    """ Identity matrix for Recurrent Weights Whh: http://arxiv.org/abs/1504.00941 """
    def initializeHiddenWeights(self, hidden_size):
        self.model['Whh'] = np.identity(hidden_size, float)*0.1
